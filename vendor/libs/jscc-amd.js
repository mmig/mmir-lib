...
//////////////////////////////////////////// MODULE EXPORTS: /////////////////////////////////////
	...
	return{
		reset_all: reset_all,
		EXEC_WEB: EXEC_WEB, // CONST
		MODE_GEN_JS: MODE_GEN_JS, //CONST
		...
		get_nfa_states: function() { return nfa_states; },
		get_dfa_table: function() { return dfa_table; },
		set_dfa_table: function(newDfaTable) { return dfa_table = newDfaTable; },
...
//		resetProblems: function(){ TODO },
		...
		print_term_actions: print_term_actions,
		print_symbol_labels: print_symbol_labels,

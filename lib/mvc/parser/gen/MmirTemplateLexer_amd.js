...
org.antlr.lang.augmentObject(MmirTemplateLexer.prototype, {
    ...
    mEscapeExit: function()  {
        try {
            ...
            // MmirTemplate.g:73:3: (s= '}@@' )
            // MmirTemplate.g:73:6: s= '}@@'
    ...
    mESC_DoEnter: function()  {
        try {
            ...
            // MmirTemplate.g:86:15: (s= '@@' )
            // MmirTemplate.g:86:18: s= '@@'
            var sStart = this.getCharIndex();
            this.match("@@"); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterBlock: function()  {
        try {
            ...
            // MmirTemplate.g:96:15: (s= '@{' )
            // MmirTemplate.g:96:18: s= '@{'
            var sStart = this.getCharIndex();
            this.match("@{"); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterStatement: function()  {
        try {
            ...
            // MmirTemplate.g:107:18: (s= '@(' )
            // MmirTemplate.g:107:22: s= '@('
            var sStart = this.getCharIndex();
            this.match("@("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterIncludeScript: function()  {
        try {
            ...
            // MmirTemplate.g:118:22: (s= '@script(' )
            // MmirTemplate.g:118:26: s= '@script('
            var sStart = this.getCharIndex();
            this.match("@script("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterIncludeStyle: function()  {
        try {
            ...
            // MmirTemplate.g:130:21: (s= '@style(' )
            // MmirTemplate.g:130:25: s= '@style('
            var sStart = this.getCharIndex();
            this.match("@style("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterLocalize: function()  {
        try {
            ...
            // MmirTemplate.g:142:17: (s= '@localize(' )
            // MmirTemplate.g:142:21: s= '@localize('
            var sStart = this.getCharIndex();
            this.match("@localize("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterDeclareVar: function()  {
        try {
            ...
            // MmirTemplate.g:154:19: (s= '@var(' )
            // MmirTemplate.g:154:23: s= '@var('
            var sStart = this.getCharIndex();
            this.match("@var("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterHelper: function()  {
        try {
            ...
            // MmirTemplate.g:166:15: (s= '@helper(' )
            // MmirTemplate.g:166:19: s= '@helper('
            var sStart = this.getCharIndex();
            this.match("@helper("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterRender: function()  {
        try {
            ...
            // MmirTemplate.g:178:15: (s= '@render(' )
            // MmirTemplate.g:178:19: s= '@render('
            var sStart = this.getCharIndex();
            this.match("@render("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterYieldDeclaration: function()  {
        try {
            ...
            // MmirTemplate.g:190:25: (s= '@yield(' )
            // MmirTemplate.g:190:29: s= '@yield('
            var sStart = this.getCharIndex();
            this.match("@yield("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterYieldContent: function()  {
        try {
            ...
            // MmirTemplate.g:202:21: (s= '@contentFor(' )
            // MmirTemplate.g:202:25: s= '@contentFor('
            var sStart = this.getCharIndex();
    ...
    mDoEnterIfStatement: function()  {
        try {
            ...
            // MmirTemplate.g:218:20: (s= '@if(' )
            // MmirTemplate.g:218:24: s= '@if('
            var sStart = this.getCharIndex();
            this.match("@if("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterElseStatement: function()  {
        try {
            ...
            // MmirTemplate.g:234:22: (s= '@else' )
            // MmirTemplate.g:234:26: s= '@else'
            var sStart = this.getCharIndex();
            this.match("@else"); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
    ...
    mDoEnterForStatement: function()  {
        try {
            ...
            // MmirTemplate.g:248:21: (s= '@for(' )
            // MmirTemplate.g:248:25: s= '@for('
            var sStart = this.getCharIndex();
            this.match("@for("); 
            var s = new org.antlr.runtime.CommonToken(this.input, org.antlr.runtime.Token.INVALID_TOKEN_TYPE, org.antlr.runtime.Token.DEFAULT_CHANNEL, sStart, this.getCharIndex()-1);
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // MmirTemplate.g:266:5: '\\r'
                    this.match('\r'); 


                    break;
                case 3 :
                    // MmirTemplate.g:267:5: '\\u2028'
                    this.match('\u2028'); 


                    break;
                case 4 :
                    // MmirTemplate.g:268:5: '\\u2029'
                    this.match('\u2029'); 
    ...
    mEND_SCRIPT: function()  {
        try {
            ...
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // MmirTemplate.g:271:12: ( '}@' )
            // MmirTemplate.g:271:15: '}@'
            this.match("}@"); 
    ...
    mCHAR: function()  {
        try {
            var _type = this.CHAR;
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // MmirTemplate.g:273:7: (~ ( '\\n' | '\\r' ) )
            // MmirTemplate.g:273:10: ~ ( '\\n' | '\\r' )
    ...
    mCOMMENT: function()  {
        try {
            ...
            // MmirTemplate.g:276:5: (start= '@*' ( options {greedy=false; } : . )* end= '*@' )
            // MmirTemplate.g:276:9: start= '@*' ( options {greedy=false; } : . )* end= '*@'
            ...
            // MmirTemplate.g:276:20: ( options {greedy=false; } : . )*
            loop3:
            do {
                var alt3=2;
    ...
    mEND: function()  {
        try {
            var _type = this.END;
            var _channel = org.antlr.runtime.BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
            // MmirTemplate.g:323:9: ( EOF )
            // MmirTemplate.g:323:11: EOF
            this.match(this.EOF); 

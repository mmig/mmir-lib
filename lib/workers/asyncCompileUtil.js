...
/**
 * helper functions etc. for async-grammar compilation
 *
 * @module workers/async-compiler-utils
 * @requires workers/worker-utils
 *
 * @see {@link module:workers/jison-compiler}
 * @see {@link module:workers/jscc-compiler}
 * @see {@link module:workers/pegjs-compiler}
 */
...
self.init = function(config){
	...
	if (config.engineUrl || (typeof WEBPACK_BUILD !== 'undefined' && WEBPACK_BUILD)){
		...
		self._init(config.engineUrl, config.libUrl);

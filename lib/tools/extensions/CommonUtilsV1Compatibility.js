define(['mmirf/jsonUtils', 'mmirf/resizeToFit'],
	 ...
	 * NOTE: needs {@link mmir.compat.v1.setToCompatibilityMode} to be set first!
	 *
	 ...
	 * on the {@link mmir.CommonUtils} instance with these additional names
	 * <ul>
	 ...
	 *
	 * @class
	 * @name mmir.compat.v1.CommonUtils
	 * @static
	 *
	 * @example
	...
	return setToCompatibilityMode = function(compatibilitySelf) {
		...
		/** @scope mmir.compat.v1.CommonUtils.prototype *///for jsdoc2
		 ...
		 * @type Object
		 * @private
		 * @memberOf mmir.compat.v1.CommonUtils#
		 * @member months
		 */
		...
		/**
		 * @private
		 * @memberOf mmir.compat.v1.CommonUtils#member
		 * @member de
		 */
...
//		var compatibilitySelf = this;
		...
		/**
		 * See Property:
		 * {@link mmir.compat.v1.CommonUtils#render_partial_regex}
		 * <br>
		...
		/**
		 * See Property:
		 * {@link mmir.compat.v1.CommonUtils#value_of_regex}
		 * <br>

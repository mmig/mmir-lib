define(['require', 'mmirf/dialogManager4Compatibility',
		'mmirf/dialogManager', 'mmirf/grammarConverter', 'mmirf/baseGen', 'mmirf/positionUtils', 'mmirf/resources', 'mmirf/commonUtils',
	...
	function(require, dialogManager4Compatibility,
		dialogManager, gc, bg, posUtil, res, utils,
		forEach, isArray
	){
	...
	return function setToCompatibilityMode(mmir) {
		 ...
		 *
		 * @param {GrammarConverter} obj the GrammarConverter instance

define(['require', 'mmirf/dialogManager4Compatibility',
		'mmirf/dialogManager', 'mmirf/grammarConverter', 'mmirf/baseGenerator', 'mmirf/resources', 'mmirf/commonUtils',
	...
	return function setToCompatibilityMode(mmir) {
		...
		////////////////////////////////// add backwards compatiblity to GrammarConverter /////////////////////////
		...
		gc.prototype.variable_prefix = bc.prototype.variable_prefix;
		gc.prototype.variable_regexp = bc.prototype.variable_regexp;
		gc.prototype.entry_token_field = bc.prototype.entry_token_field;
		gc.prototype.entry_index_field = bc.prototype.entry_index_field;
		gc.prototype.entry_type_field = bc.prototype.entry_type_field;

...
GrammarConverter.prototype.preproc = function(thePhrase, pos, maskFunc, stopwordFunc){
	...
	var str = maskFunc? maskFunc(thePhrase, !!pos) : this.maskString(thePhrase, !!pos);
	...
	var result = stopwordFunc? stopwordFunc(str, !!pos) : this.removeStopwords(str, !!pos);

	var stopwordPos;
	if(typeof result === 'object'){
		if(pos){
			pos.stopwords = result.pos;
		}
		stopwordPos = result.pos;
		result = result.text;
	}

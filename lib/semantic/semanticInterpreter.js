...
//	        	}
		 ...
		 * @memberOf mmir.SemanticInterpreter#
		 */
		var doRemoveStopWords = function(thePhrase, lang, processingSteps){
			if(!doCheckIsEnabled()){
		...
		var _tmpInstance = { // public members
			 ...
			 * 					the ID (identifier) / language code for grammar
			 * @public
			 * @see GrammarConverter#getGrammarSource
			 */
			 ...
			 * @returns {GrammarConverter} the grammar converter
			 *
			 * @see #addGrammar
